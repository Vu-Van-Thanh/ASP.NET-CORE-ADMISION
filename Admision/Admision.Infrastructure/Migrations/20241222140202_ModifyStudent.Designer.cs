...
namespace Admission.Infrastructure.Migrations
{
    ...
    [Migration("20241222140202_ModifyStudent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Admission.Core.Domain.Entities.Result", b =>
                {
                    b.HasOne("Admission.Core.Domain.Entities.InformationOfApplied", "Info")
                        .WithMany()
                        .HasForeignKey("InfoAppliedID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
